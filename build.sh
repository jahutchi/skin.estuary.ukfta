...
kodi-TexturePacker -dupecheck -input $SRC_DIR/media -output $PROJECT_OUT_DIR/media/Textures.xbt
kodi-TexturePacker -dupecheck -input $SRC_DIR/themes/curial -output $PROJECT_OUT_DIR/media/curial.xbt
kodi-TexturePacker -dupecheck -input $SRC_DIR/themes/flat -output $PROJECT_OUT_DIR/media/flat.xbt
